      ...
      <div className="relative bg-white border-round-xl p-6 w-11 sm:w-8 md:w-8 lg:w-8 shadow-4 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="flex flex-column mt-4">
          <div className="flex flex-column align-items-center">
            <label htmlFor="file-upload" className="w-full text-center cursor-pointer border-dotted border-2 border-primary p-5">
          ...
          <textarea
            ...
            className="mt-4 bg-tint-5 text-base p-2 border-1 border-solid surface-border border-round appearance-none outline-none focus:border-primary w-full h-6rem"
            required
          />
