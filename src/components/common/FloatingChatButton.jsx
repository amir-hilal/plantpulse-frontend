...
const FloatingChatButton = ({ onClick }) => {
  return (
    <div className="fixed bottom-0 right-0 z-50 cursor-pointer mr-4 mb-4">
      <button
        className="bg-secondary border-round-3xl border-none hover:surface-800 text-white p-3 rounded-full shadow-lg  transition duration-300 flex align-items-center"
        onClick={onClick}
      >
