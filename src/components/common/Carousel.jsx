  ...
  const renderFeature = (feature, index) => {
    return (
      <div key={index} className="flex justify-content-center">
        <div
          className="bg-tint-5 p-3 lg:p-8 m-5 max-w-14rem  md:max-w-18rem md:max-w-22rem min-h-10  border-round-lg shadow-2 text-center flex flex-column align-items-center justify-content-center"
          style={{
            transition: 'all 0.5s ease',
          }}
        >
          <img src={feature.img} alt="feature" />
          <h3 className="text-lg text-secondary font-bold m-0">
            {feature.title}
          </h3>
